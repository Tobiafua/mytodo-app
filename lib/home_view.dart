import 'package:mytodo_app/create_todo_view.dart';
import 'package:mytodo_app/utils.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  final _unCompletedData = [];

  final _completedData = [];
